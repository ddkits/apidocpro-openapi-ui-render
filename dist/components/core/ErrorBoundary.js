  ...
  _createClass(ErrorBoundary, [{
    ...
    value: function render() {
      ...
      if (this.state.errorInfo) {
        // Error path
        return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "An Error Has Occurred"), /*#__PURE__*/React.createElement("details", null, this.state.error && this.state.error.toString(), /*#__PURE__*/React.createElement("br", null), this.state.errorInfo.componentStack));
      }
